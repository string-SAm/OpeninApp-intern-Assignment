...
- Project Live Link 2: [Live Demo - netlify.app](https://intern-listedassignment.netlify.app/)

## Installation

To install and run this React project, follow the steps below:

- git clone ![Clone Repo](https://github.com/string-SAm/listedAssignment.git) `https://github.com/string-SAm/listedAssignment.git`
